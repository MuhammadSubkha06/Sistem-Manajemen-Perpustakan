                ...
                <form method="POST" action="{{ route('admin.peminjaman.update', $peminjaman) }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" name="tgl_pinjam" class="form-control @error('tgl_pinjam') is-invalid @enderror" value="{{ old('tgl_pinjam', optional($peminjaman->tgl_pinjam)->toDateString()) }}">
                            @error('tgl_pinjam')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Rencana Kembali</label>
                            <input type="date" name="tgl_kembali_rencana" class="form-control @error('tgl_kembali_rencana') is-invalid @enderror" value="{{ old('tgl_kembali_rencana', optional($peminjaman->tgl_kembali_rencana)->toDateString()) }}">
